...
public struct Mime: Hashable, Codable {
    ...
    public enum Error: Swift.Error {
        ...
        /// No mime type was found for the given file extension
    ...
    /// Initializes and returns the MimeType object from the given file extension or throws when given an unknown extension.
    ///
    /// - Parameters:
    ///   - ext: The file extension
    public init(ext: String) throws {
        guard let mime = Self.mimeTypes[ext.lowercased()] else {
            throw Mime.Error.unknownExtension
        }
        
        self.init(mime: mime.0, ext: ext, type: mime.1)
    }
    
    /// Initializes and returns the MimeType obejct from the given url or throws when given an unknown extension.
    public init(url: URL) throws {
        try self.init(ext: url.pathExtension)
    }
